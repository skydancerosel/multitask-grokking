#!/usr/bin/env python3
"""WD=0.2, seed=2024: train + Hessian."""
...
def main():
    ...
    hess = analyze_hessian(data, f"wd02_s{SEED}", SEED, k=5, n_iter=25)

    save_path = PLOT_DIR / f"hessian_wd02_s{SEED}.pt"
